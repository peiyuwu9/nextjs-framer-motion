...
function ConfigBtn({ formId }: Props) {
  ...
  function handlePrevent(event: MouseEvent<HTMLDivElement>) {
    event.preventDefault();
  }
  ...
  return (
    ...
    >
      ...
      <div
        className={`z-10 bg-gray-200 rounded-lg shadow-lg w-20 absolute translate-x-7 -translate-y-7 ${
          show ? "block" : "hidden"
        }`}
      >
        <ul className="py-2">
          <li>
            <div
              className="block px-4 py-2 text-sm text-gray-600 text-start hover:bg-orange-300 hover:text-white"
